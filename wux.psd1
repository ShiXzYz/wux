@{
    ...
    Author            = 'ShiXzYz'
    Description       = 'Linux-style commands for PowerShell: grep, awk, sed, head, tail, find, touch, chmod, nano, ss, systemctl, df, du, ps, kill, which, wc, tee, free, uptime, uniq, env, cat, whoami, cp, mv, mkdir, chown, ls'
